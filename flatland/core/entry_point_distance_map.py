...
class EntryPointDistanceMap(Generic[UnderlyingTransitionMapType, UnderlyingDistanceMapType, UnderlyingEntryPointType, UnderlyingWaypointType]):
    """
    ...
    def __init__(self, agents: List[EnvAgent], waypoint_init: Callable[[UnderlyingEntryPointType], UnderlyingWaypointType]):
        ...
        self.distances: Dict[
            Tuple[UnderlyingEntryPointType, UnderlyingEntryPointType], int
    ...
    def _set_distance(self, source_entry_point: UnderlyingEntryPointType,
                      target_entry_point: UnderlyingEntryPointType, new_distance: int):
        self.distances[(source_entry_point, target_entry_point)] = new_distance

    def _get_distance(self, source_entry_point: UnderlyingEntryPointType,
                      target_entry_point: UnderlyingEntryPointType) -> int:
