...
class ContextOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "date", "id_context", "use_case"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContextOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContextOut from a dict"""
        if obj is None:
            return None
