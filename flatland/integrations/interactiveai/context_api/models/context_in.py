...
class ContextIn(BaseModel):
    ...
    use_case: StrictStr
    __properties: ClassVar[List[str]] = ["data", "date", "use_case"]

    @field_validator('use_case')
    def use_case_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PowerGrid', 'Railway', 'ATM']):
            raise ValueError("must be one of enum values ('PowerGrid', 'Railway', 'ATM')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContextIn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContextIn from a dict"""
        if obj is None:
            return None
