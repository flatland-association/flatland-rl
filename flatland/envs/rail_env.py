...
class RailEnv(Environment):
    ...
    def step(self, action_dict: Dict[int, RailEnvActions]):
        ...
        for agent in self.agents:
            ...
            # Stop action given
            self.temp_transition_data[i_agent].state_transition_signal.stop_action_given = (preprocessed_action == RailEnvActions.STOP_MOVING)
            # Movement action given
            self.temp_transition_data[i_agent].state_transition_signal.movement_action_given = RailEnvActions.is_moving_action(preprocessed_action)
