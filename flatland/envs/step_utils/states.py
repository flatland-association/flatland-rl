...
class StateTransitionSignals:
    def __init__(self, in_malfunction: bool = False, earliest_departure_reached: bool = False, stop_action_given: bool = False,
                 ...
                 action_valid: bool = False, ready_to_depart: bool = False):
        ...
        # the real, no-+1 "is it READY_TO_DEPART this exact step" formula - matches rail_env.py's
        # _candidate_entry_points' own ready_to_depart exactly, unlike earliest_departure_reached above
        # (deliberately signalled one step early). See _handle_malfunction_off_map's own use of this
        # distinction (PR #517 review comment r3965564459).
        self.ready_to_depart = ready_to_depart
    ...
    def __repr__(self):
        return (f"StateTransitionSignals(in_malfunction={self.in_malfunction}, earliest_departure_reached={self.earliest_departure_reached}, "
                ...
                f"action_valid={self.action_valid}, ready_to_depart={self.ready_to_depart})")
    ...
    def __eq__(self, other):
        return isinstance(other, StateTransitionSignals) and (
            ...
            self.target_reached, self.movement_allowed, self.new_speed_zero, self.action_valid, self.ready_to_depart
        ) == (
            other.in_malfunction, other.earliest_departure_reached, other.stop_action_given, other.movement_action_given,
            other.target_reached, other.movement_allowed, other.new_speed_zero, other.action_valid, other.ready_to_depart
        )
    ...
    def __getstate__(self):
        return {
            ...
            "ready_to_depart": self.ready_to_depart,
        }
    ...
    def __setstate__(self, state):
        ...
        self.ready_to_depart = state.get("ready_to_depart", False)
