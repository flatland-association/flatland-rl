...
def complex_schedule_generator(speed_ratio_map: Mapping[float, float] = None, seed: int = 0) -> ScheduleGenerator:
...
def sparse_schedule_generator(speed_ratio_map: Mapping[float, float] = None, seed: int = 0) -> ScheduleGenerator:
