...
def ndom_seeding():
    ...
    for idx in range(100):
        ...
        env.agents[0].initial_entry_point[0] == (3, 2)
        env.agents[1].initial_entry_point[0] == (3, 5)
        env.agents[2].initial_entry_point[0] == (3, 6)
        env.agents[3].initial_entry_point[0] == (5, 6)
        env.agents[4].initial_entry_point[0] == (3, 4)
        env.agents[5].initial_entry_point[0] == (3, 1)
        env.agents[6].initial_entry_point[0] == (3, 9)
        env.agents[7].initial_entry_point[0] == (4, 6)
        env.agents[8].initial_entry_point[0] == (0, 3)
        env.agents[9].initial_entry_point[0] == (3, 7)
        ...
        # print("assert env.agents[0].current_entry_point[0] ==  {}".format(env.agents[0].current_entry_point[0]))
...
def test_seeding_and_observations():
    ...
    assert env.agents[0].initial_entry_point[0] == env2.agents[0].initial_entry_point[0]
    assert env.agents[1].initial_entry_point[0] == env2.agents[1].initial_entry_point[0]
    assert env.agents[2].initial_entry_point[0] == env2.agents[2].initial_entry_point[0]
    assert env.agents[3].initial_entry_point[0] == env2.agents[3].initial_entry_point[0]
    assert env.agents[4].initial_entry_point[0] == env2.agents[4].initial_entry_point[0]
    assert env.agents[5].initial_entry_point[0] == env2.agents[5].initial_entry_point[0]
    assert env.agents[6].initial_entry_point[0] == env2.agents[6].initial_entry_point[0]
    assert env.agents[7].initial_entry_point[0] == env2.agents[7].initial_entry_point[0]
    assert env.agents[8].initial_entry_point[0] == env2.agents[8].initial_entry_point[0]
    assert env.agents[9].initial_entry_point[0] == env2.agents[9].initial_entry_point[0]
