...
def test_timetable_generator():
    env_agents = [
        EnvAgent(handle=0, initial_entry_point=((11, 40), 3), targets={((39, 8), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=1, initial_entry_point=((38, 8), 1), targets={((10, 40), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=2, initial_entry_point=((17, 5), 3), targets={((42, 22), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=3, initial_entry_point=((41, 22), 3), targets={((18, 5), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=4, initial_entry_point=((11, 40), 1), targets={((39, 8), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=5, initial_entry_point=((38, 8), 3), targets={((12, 40), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=6, initial_entry_point=((38, 8), 1), targets={((31, 27), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=7, initial_entry_point=((31, 26), 0), targets={((39, 8), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=8, initial_entry_point=((41, 22), 1), targets={((8, 27), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
        EnvAgent(handle=9, initial_entry_point=((9, 27), 3), targets={((44, 22), d) for d in Grid4TransitionsEnum}, current_entry_point=None,
                 waypoints_latest_arrival=None,
                 waypoints_earliest_departure=None),
    ]
    agents_hints = {
