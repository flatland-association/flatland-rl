...
def test_timetable_generator():
    env_agents = [
        EnvAgent(handle=0, initial_position=(11, 40), initial_direction=3, target=(39, 8), direction=3, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=1, initial_position=(38, 8), initial_direction=1, target=(10, 40), direction=1, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=2, initial_position=(17, 5), initial_direction=3, target=(42, 22), direction=3, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=3, initial_position=(41, 22), initial_direction=3, target=(18, 5), direction=3, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=4, initial_position=(11, 40), initial_direction=1, target=(39, 8), direction=1, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=5, initial_position=(38, 8), initial_direction=3, target=(12, 40), direction=3, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=6, initial_position=(38, 8), initial_direction=1, target=(31, 27), direction=1, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=7, initial_position=(31, 26), initial_direction=0, target=(39, 8), direction=0, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=8, initial_position=(41, 22), initial_direction=1, target=(8, 27), direction=1, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
        EnvAgent(handle=9, initial_position=(9, 27), initial_direction=3, target=(44, 22), direction=3, intermediate_latest_arrival=None,
                 intermediate_earliest_departure=None),
    ]
    agents_hints = {
    ...
    assert timetable.earliest_departures == [[14], [70], [94], [16], [17], [50], [130], [6], [27], [67]]
    assert timetable.latest_arrivals == [[134], [190], [178], [103], [143], [170], [193], [189], [147], [148]]
