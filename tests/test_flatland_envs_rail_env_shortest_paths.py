...
def test_get_shortest_paths():
    ...
    expected = {
        ...
        1: [
            ...
            WalkingElement(position=(2, 3), direction=3, next_action=RailEnvActions.MOVE_FORWARD),
            WalkingElement(position=(2, 2), direction=3, next_action=RailEnvActions.MOVE_FORWARD),
            WalkingElement(position=(2, 1), direction=3, next_action=RailEnvActions.STOP_MOVING)]
    }
...
def test_get_k_shortest_paths(rendering=False):
    ...
    expected = set([
        (
            WalkingElement(position=(3, 1), direction=3, next_action=2),
            WalkingElement(position=(3, 0), direction=3, next_action=2),
            WalkingElement(position=(3, 1), direction=1, next_action=2),
            WalkingElement(position=(3, 2), direction=1, next_action=2),
            WalkingElement(position=(3, 3), direction=1, next_action=1),
            WalkingElement(position=(2, 3), direction=0, next_action=2),
            WalkingElement(position=(1, 3), direction=0, next_action=2),
            WalkingElement(position=(0, 3), direction=0, next_action=2),
            WalkingElement(position=(0, 4), direction=1, next_action=2),
            WalkingElement(position=(0, 5), direction=1, next_action=2),
            WalkingElement(position=(0, 6), direction=1, next_action=2),
            WalkingElement(position=(0, 7), direction=1, next_action=2),
            WalkingElement(position=(0, 8), direction=1, next_action=2),
            WalkingElement(position=(0, 9), direction=1, next_action=2),
            WalkingElement(position=(1, 9), direction=2, next_action=2),
            WalkingElement(position=(2, 9), direction=2, next_action=2),
            WalkingElement(position=(3, 9), direction=2, next_action=0)),
        (
            WalkingElement(position=(3, 1), direction=3, next_action=2),
            WalkingElement(position=(3, 0), direction=3, next_action=2),
            WalkingElement(position=(3, 1), direction=1, next_action=2),
            WalkingElement(position=(3, 2), direction=1, next_action=2),
            WalkingElement(position=(3, 3), direction=1, next_action=2),
            WalkingElement(position=(3, 4), direction=1, next_action=2),
            WalkingElement(position=(3, 5), direction=1, next_action=2),
            WalkingElement(position=(3, 6), direction=1, next_action=2),
            WalkingElement(position=(4, 6), direction=2, next_action=2),
            WalkingElement(position=(5, 6), direction=2, next_action=2),
            WalkingElement(position=(6, 6), direction=2, next_action=2),
            WalkingElement(position=(5, 6), direction=0, next_action=2),
            WalkingElement(position=(4, 6), direction=0, next_action=3),
            WalkingElement(position=(4, 7), direction=1, next_action=2),
            WalkingElement(position=(4, 8), direction=1, next_action=2),
            WalkingElement(position=(4, 9), direction=1, next_action=2),
            WalkingElement(position=(3, 9), direction=0, next_action=0))
    ])
