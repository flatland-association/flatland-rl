...
@pytest.mark.parametrize("env_creator,expected_num_vertices,expected_num_edges", [
...
def test_simple_rail_simplification(env_creator, expected_num_vertices, expected_num_edges):
