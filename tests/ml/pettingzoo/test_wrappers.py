...
from flatland.envs.rail_env_utils import env_generator
...
def test_parallel_pettingzoo():
    env = PettingzooFlatland(env_generator(
        obs_builder_object=FlattenedNormalizedTreeObsForRailEnv(max_depth=3, predictor=ShortestPathPredictorForRailEnv(max_depth=50)))).parallel_env()
