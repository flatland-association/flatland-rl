...
########################################
# observation_builder = ObsRepository.GlobalObsForRailEnv(standardized_observation=True)
# observation_builder = ObsRepository.GlobalObsForRailEnv()

# observation_builder = ObsRepository.LocalObsForRailEnv(3, 3, 0, standardized_observation=True)
# observation_builder = ObsRepository.LocalObsForRailEnv(3, 3, 0)

observation_builder = ObsRepository.TreeObsForRailEnv(max_depth=3, standardized_observation=True)
