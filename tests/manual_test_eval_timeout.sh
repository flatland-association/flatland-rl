...
#gnome-terminal --title Service --window -- python -m flatland.evaluators.service --test-folder  ../submission-scoring/Envs/neurips2020_round1_v0/
xterm -title Service -hold -e "python -m flatland.evaluators.service --test-folder  ../submission-scoring/Envs/neurips2020_round1_v0/   " &
